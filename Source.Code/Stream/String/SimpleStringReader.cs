...
/// 簡易テキスト読込処理クラスです。
/// </summary>
public sealed class SimpleStringReader : StringReader, IDisposable {
	#region メンバー変数定義
	/// <summary>
	/// 要素情報
	/// </summary>
	...
	public SimpleStringReader(string source, int offset, int length) {
		this.source = source;
		this.offset = offset;
		this.length = length;
	}
	...
	/// </summary>
	/// <param name="source">要素情報</param>
	public SimpleStringReader(string source) : this(source, 0, source.Length) {
		// 処理なし
	}
	#endregion 生成メソッド定義
